...
class file {//类定义开始
    ...
    private $config =   array(
        ...
        'imageClassPath'    =>  'system/lib/image.class.php',    // 图库类包路径
        ...
        'savePath'          =>  'static/uploads/',// 上传文件保存路径
    ...
    private function save($file) {
        ...
        if($this->thumb && in_array(strtolower($file['extension']),array('gif','jpg','jpeg','bmp','png'))) {
            ...
            if(false !== $image) {
                ...
                // 生成图像缩略图
                include_once $this->imageClassPath;
    ...
    public function upload($savePath ='') {
        ...
        foreach($files as $key => $file) {
            ...
            if(!empty($file['name'])) {
                ...
                $file['savepath']   = $this->savePath.$this->getSubName($file);//组合存储路径
                //$file['subname'] = $this->getSubName($file);
    ...
    private function getSaveName($filename) {
        ...
        if($this->autoSub) {
            ...
            //$saveName = $this->getSubName($filename).$saveName;//去除subpath
        }
        return $saveName;
    }
...
//         if(!is_dir($this->savePath.$dir)) {
//             mkdir($this->savePath.$dir,0777,true);
//         }
        return $dir;
    }
